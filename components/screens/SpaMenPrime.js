...
import spamen from '../assets/spamen.jpeg';
import Offer from '../assets/Offer.png';
import Ionicons from 'react-native-vector-icons/Ionicons';

const SpaMenPrime = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/SpaMenPrime`);
...
    };
    ...
    return (
        ...
        <Ionicons name="arrow-back" size={24} color="black" />
         ...
         <Image source={spamen} style={styles.image} />
       <Text style={styles.title}>Massage for Men Prime</Text>
