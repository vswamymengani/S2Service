...
import BedBugs from '../assets/BedBugs.jpeg';
import Offer from '../assets/Offer.png';
import Ionicons from 'react-native-vector-icons/Ionicons';

const BedBugsControl = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/s2BedBugsControl`);
...
    };
    ...
    return (
        ...
        <Ionicons name="arrow-back" size={24} color="black" />
         ...
         <Image source={BedBugs} style={styles.image} />
       <Text style={styles.title}>Bed Bugs Control</Text>
