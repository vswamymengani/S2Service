...
const SalonMenPrime = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/SalonMenPrime`);
...
    };
    ...
    return (
       ...
       <Text style={styles.title}>Salon Men Prime</Text>
