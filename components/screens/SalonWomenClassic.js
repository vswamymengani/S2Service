...
//import SalonWomenp from '../assets/SalonWomenp.avif';
import Offer from '../assets/Offer.png';
import Ionicons from 'react-native-vector-icons/Ionicons';

const SalonWomenClassic = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/SalonWomenClassic`);
...
    };
    ...
    return (
        ...
        <Ionicons name="arrow-back" size={24} color="black" />
         ...
         {/* <Image source={SalonWomenp} style={styles.image} /> */}
       <Text style={styles.title}>Salon Women Classic</Text>
...
export default SalonWomenClassic;
