...
const MicrowaveService = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/s2MicrowaveService`);
...
    };
    ...
    return (
        ...
        <Ionicons name="arrow-back" size={24} color="black" />
         ...
         <Image source={microwave} style={styles.image} />
       <Text style={styles.title}>Microwave Repair & Service</Text>
