...
import SofaCleaning from '../assets/SofaCleaning.jpeg';
import Offer from '../assets/Offer.png';
import Ionicons from 'react-native-vector-icons/Ionicons';

const SofaCleaningService = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/s2SofaCleaningService`);
...
    };
    ...
    return (
        ...
        <Ionicons name="arrow-back" size={24} color="black" />
         ...
         <Image source={SofaCleaning} style={styles.image} />
       <Text style={styles.title}>Sofa & Carpet Cleanig</Text>
...
export default SofaCleaningService;
