...
const SpaWomenLuxe = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/SpaWomenLuxe`);
...
    };
    ...
    return (
       ...
       <Text style={styles.title}>Spa Women Luxe</Text>
