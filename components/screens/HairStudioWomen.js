...
const HairStudioWomen = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/HairStudioWomen`);
...
    };
    ...
    return (
       ...
       <Text style={styles.title}>Hair Studio For Women</Text>
...
export default HairStudioWomen;
