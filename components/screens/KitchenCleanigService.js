...
import KitchenCleanig from '../assets/KitchenCleanig.jpeg';
import Offer from '../assets/Offer.png';
import Ionicons from 'react-native-vector-icons/Ionicons';

const KitchenCleanigService = ({ navigation, route }) => {
...
    };
    ...
    return (
        ...
        <Ionicons name="arrow-back" size={24} color="black" />
         ...
         <Image source={KitchenCleanig} style={styles.image} />
       <Text style={styles.title}>Bathroom &Kitchen Cleanig</Text>
...
export default KitchenCleanigService;
