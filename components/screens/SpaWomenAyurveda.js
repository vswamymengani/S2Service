...
const SpaWomenAyurveda = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/Ayurveda`);
...
    };
    ...
    return (
       ...
       <Text style={styles.title}>Spa Women Ayurveda</Text>
...
export default SpaWomenAyurveda;
