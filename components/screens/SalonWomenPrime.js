...
const SalonWomenPrime = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/SalonWomenPrime`);
...
    };
    ...
    return (
       ...
       <Text style={styles.title}>Salon Women Prime</Text>
...
export default SalonWomenPrime;
