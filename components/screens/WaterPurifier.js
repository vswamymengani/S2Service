...
const WaterPurifier = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/s2WaterPurifier`);
...
    };
    ...
    return (
       ...
       <Text style={styles.title}>Water Purifier Repair & Service</Text>
