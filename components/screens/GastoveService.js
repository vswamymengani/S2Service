...
import Gastove from '../assets/Gastove.webp';
import Offer from '../assets/Offer.png';
import Ionicons from 'react-native-vector-icons/Ionicons';

const GastoveService = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/s2gastoveservice`);
...
    };
    ...
    return (
        ...
        <Ionicons name="arrow-back" size={24} color="black" />
         ...
         <Image source={Gastove} style={styles.image} />
       <Text style={styles.title}>Gas Stove Repair & Service</Text>
