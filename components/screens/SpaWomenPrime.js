...
const SpaWomenPrime = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/SpaWomenPrime`);
...
    };
    ...
    return (
       ...
       <Text style={styles.title}>Spa Women Prime</Text>
