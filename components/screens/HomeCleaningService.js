...
import Full_Home_Cleaning from '../assets/Full_Home_Cleaning.jpeg';
import Offer from '../assets/Offer.png';
import Ionicons from 'react-native-vector-icons/Ionicons';

const HomeCleaningService = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/s2Full_Home_Cleaning`);
...
    };
    ...
    return (
        ...
        <Ionicons name="arrow-back" size={24} color="black" />
         ...
         <Image source={Full_Home_Cleaning} style={styles.image} />
       <Text style={styles.title}>Full_Home_Cleaning</Text>
