...
import salonmen from '../assets/salonmen.jpeg';
import Offer from '../assets/Offer.png';
import Ionicons from 'react-native-vector-icons/Ionicons';

const SalonMenRoyale = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/SalonMenRoyale`);
...
    };
    ...
    return (
        ...
        <Ionicons name="arrow-back" size={24} color="black" />
         ...
         <Image source={salonmen} style={styles.image} />
       <Text style={styles.title}>Salon Men Royale</Text>
