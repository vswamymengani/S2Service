...
const SpaMenRoyal = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://10.0.2.2:3000/api/SpaMenRoyal`);
...
    };
    ...
    return (
       ...
       <Text style={styles.title}>Massage for Men Royale</Text>
